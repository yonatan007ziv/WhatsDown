...
internal class SmtpEmailSenderService : IEmailSender
{
	...
	public SmtpEmailSenderService(IConfigurationFetcher configuration, ILogger logger)
	{
		try
		{
		...
		catch (ConfigurationAttributeNotFound ex)
		{
			...
			throw new ServiceInitializationException(nameof(SmtpEmailSenderService));
		}
